    ...
    <div class="container-xxl position-relative p-0">
        <div class="container-xxl bg-primary page-header">
            <div class="container text-center">
                <h1 class="text-white animated zoomIn mb-3">School Fee Payments</h1>
            </div>
        </div>
    </div>
    <center>
        <div runat="server" id="sear" style="text-align:center;">
            <h3>Payment History</h3>
            <asp:TextBox type="text" ID="Box2" runat="server" AutoPostBack="true" value=""></asp:TextBox>
            <asp:Button ID="Button1" runat="server" Text="Search by Student ID" OnClick="Button1_Click" />
